...
<!-- sisu -->
 ...
 <div class="container">
  <h2>Admin ala</h2>
  <a class="btn btn-success" href="lisa.php">Lisa auto</a>
  ...
  <tbody>
   ...
   <!-- DELETE FROM cars WHERE id=46; -->
    <tr>
      ...
      <td><a class="btn btn-danger" href="kustuta.php?delid=<?= $rida["id"]; ?>">Kustuta</a></td>
      <td><a class="btn btn-warning" href="muuda.php?editid=<?= $rida["id"]; ?>">Muuda</a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
