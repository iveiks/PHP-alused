...
<?php
    if(!empty($_GET)){
        ...
        $sql = "INSERT INTO cars (mark, model, engine, fuel, price, year, transmission, seats, description, status, image) VALUES ('".$mark."', '".$model."', '".$engine."', '".$fuel."', '".$price."', '".$year."', '".$transmission."', '".$seats."', '".$description."', '".$status."', 'test')";
  ...
  <form action="lisa.php" method="get">
    <div class="row g-4">
        <div class="col-sm-6">
            ...
            <input type="number" class="form-control" id="price" name="price" value="20">
        </div>
        <div class="col-sm-6">
